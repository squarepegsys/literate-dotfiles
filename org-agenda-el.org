...
(setq org-agenda-custom-commands
      ...
      ("w" "Well Tasks" tags-todo "well"
        ...
        ("s" "Shift" tags-todo "Shift Worship"
         ((org-agenda-files '("~/org/" "~/pDrive/org/tasks/task.org"))
          (org-agenda-sorting-strategy '(priority-up effort-down)))
        ("p" "Powerhouse" tags-todo "Powerhouse"
         ((org-agenda-files '("~/org/" "~/pDrive/org/tasks/task.org"))
...
| s | Shift            | tags-todo | Shift Worship | ((org-agenda-files (quote (~/org/ ~/pDrive/org/tasks/task.org))) (org-agenda-sorting-strategy (quote (priority-up effort-down)))) | (~/org/powerhouse.html)       |
