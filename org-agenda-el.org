...
:END:" :prepend t)
    ...
    ("r" "Recur" entry (file+datetree "~/pdrive/org/tasks/task.org")
         "* RECUR %?\nEntered on %U\n  :SCHEDULED:  %U \n%i\n  %a\n")
  )
)
...
(setq org-todo-keywords
   '((sequence "TODO" "EPIC" "STORY" "RECUR" "APPT" "NOTE" "STARTED" "WAITING" "DELEGATED" "DEFERRED" "SOMEDAY" "PROJECT" "DONE" "TO-READ" "READ"))
)
...
#+RESULTS:
| w | Well Tasks       | tags-todo | well       | 1                                                                                                                                 | ((org-agenda-files (quote (~/org/ ~/pDrive/org/tasks/task.org))) (org-agenda-sorting-strategy (quote (priority-up effort-down)))) | (~/org/wellco.html) |
