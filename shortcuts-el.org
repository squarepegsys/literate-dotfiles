...
(global-set-key (kbd "C-;") 'company-+END_SRC)

; doesn't belong here but spices dired up
(custom-set-variables '(dired-listing-switches "-al --time-style=long-iso --block-size='1"))
